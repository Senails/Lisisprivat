...
{ //канвас2
    ...
    { //текст с процентами
        ...
        ctx.textBaseline = 'top';
        ctx.fillText("3%", 140, 0);
        ctx.strokeText("3%", 140, 0);

        ctx.fillText("10%", 140, 80);
        ctx.strokeText("10%", 140, 80);

        ctx.fillText("8%", 310, 0);
        ctx.strokeText("8%", 310, 0);

        ctx.fillText("12%", 550, 0);
        ctx.strokeText("12%", 550, 0);

        ctx.textBaseline = 'bottom';
        ctx.fillText("51%", 610, 850);
        ctx.strokeText("51%", 610, 850);

        ctx.fillText("6%", 72, 850);
        ctx.strokeText("6%", 72, 850);

        ctx.fillText("10%", 355, 850);
        ctx.strokeText("10%", 355, 850);
